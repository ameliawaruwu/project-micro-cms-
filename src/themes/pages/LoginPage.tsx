...
export const LoginPage: React.FC<LoginPageProps> = ({ themeData, themeId: propThemeId, store, onNavigate }) => {
      ...
      return (
        <div className="pt-24 pb-24 bg-white text-black min-h-screen border-b-8 border-black">
          <div className="max-w-md mx-auto px-6">
            <h1 className="text-6xl font-black uppercase tracking-tighter mb-8 text-center">
              MASUK AKUN
            </h1>
            <div className="bg-[#FF0000] p-8 border-8 border-black shadow-[12px_12px_0px_rgba(0,0,0,1)] space-y-6">
              <input type="email" defaultValue="pelanggan@example.com" placeholder="EMAIL" className="w-full p-4 bg-white border-4 border-black font-black uppercase text-sm" />
              <input type="password" defaultValue="••••••••" placeholder="KATA SANDI" className="w-full p-4 bg-white border-4 border-black font-black uppercase text-sm" />
        ...
        <div className="pt-28 pb-24 bg-[#0B0F19] text-white min-h-screen font-mono">
          <div className="max-w-md mx-auto px-6">
            <div className="text-center mb-8">
              <span className="text-xs text-cyan-400 uppercase tracking-widest">[AUTHENTICATION_GATE]</span>
            ...
            <div className="bg-slate-900/60 border border-cyan-500/30 rounded-3xl p-8 backdrop-blur-md space-y-4">
              <input type="email" defaultValue="pelanggan@example.com" className="w-full p-3 bg-slate-950 border border-slate-800 rounded-xl text-cyan-300 text-sm focus:border-cyan-400" />
              <input type="password" defaultValue="••••••••" className="w-full p-3 bg-slate-950 border border-slate-800 rounded-xl text-cyan-300 text-sm focus:border-cyan-400" />
      ...
      <div className="pt-28 pb-24 bg-gray-50 text-gray-900 min-h-screen font-sans">
        <div className="max-w-md mx-auto px-6">
          <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm space-y-6">
            <h1 className="text-2xl font-bold text-center text-gray-900">Masuk ke Akun Anda</h1>
            ...
            <div className="flex justify-between text-xs text-gray-500 pt-2 border-t border-gray-100">
              ...
              <span className="hover:underline cursor-pointer">Daftar Akun Baru</span>
            </div>
          </div>
        </div>
      </div>
