...
export const ProductDetailModal: React.FC<ProductDetailModalProps> = ({
  ...
  return (
    <div id="modal-product-detail" className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs overflow-y-auto font-sans">
      <div className="bg-white rounded-3xl max-w-2xl w-full p-5 sm:p-7 shadow-xl border border-[#EAEAEA] my-6 animate-in fade-in zoom-in duration-200">
        {/* Header with Close */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {/* Photo Gallery */}
          <div>
            <div className="aspect-square rounded-2xl bg-[#F7F7F7] border border-[#EAEAEA] overflow-hidden relative">
              <img
              ...
              />
              {hasDiscount && (
                <div className="absolute top-3 left-3 bg-[#9A0602] text-white font-bold text-xs px-2.5 py-1 rounded-full shadow-xs">
          ...
          <div className="flex flex-col justify-between space-y-4">
            <div>
              ...
              <div className="mt-2 text-xs font-semibold">
                {isOutOfStock ? (
                  <span className="text-[#9A0602]">❌ Stok Habis</span>
                ) : (
              ...
              {/* Description */}
              <div className="mt-3.5 pt-3 border-t border-[#EAEAEA]">
              ...
              {/* Trust Badges */}
              <div className="mt-4 grid grid-cols-2 gap-2 text-xs text-[#555555] font-medium bg-[#F7F7F7] p-2.5 rounded-xl border border-[#EAEAEA]">
            ...
            <div className="pt-3 border-t border-[#EAEAEA] space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center bg-[#F7F7F7] rounded-xl p-1 border border-[#EAEAEA]">
                  <button
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <button
                  ...
                  className="py-2.5 px-3 min-h-[44px] rounded-xl bg-[#F7F7F7] hover:bg-[#EAEAEA] text-[#1F1F1F] font-semibold text-xs flex items-center justify-center gap-2 transition disabled:opacity-40 cursor-pointer"
                >
                ...
                <button
                  onClick={handleBuy}
                  disabled={isOutOfStock}
                  className="py-2.5 px-3 min-h-[44px] rounded-xl bg-[#9A0602] hover:bg-[#7D0502] text-white font-semibold text-xs flex items-center justify-center gap-2 transition shadow-xs disabled:opacity-40 cursor-pointer"
                >
