            ...
            <div className="mb-10">
              ...
              <div className="bg-white border border-[#E1E3E5] rounded-xl shadow-xs overflow-visible">
                <div className="flex flex-col">
                  {(() => {
                    const validThemes = (showAllDrafts ? savedThemes : savedThemes.slice(0, 3)).filter((t: any) => t && t.id && t.storeTemplate && t.storeTemplate.id);
                    return validThemes.map((savedTmpl, idx) => {
                    ...
                    const isLast = idx === validThemes.length - 1;
