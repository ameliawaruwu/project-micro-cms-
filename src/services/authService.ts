...
const defaultAccounts: StoredAccount[] = [
  {
    id: 'usr-andhika-01',
    email: 'andhikagonzales@gmail.com',
    password: 'password123',
    user: {
      id: 'usr-andhika-01',
      name: 'Andhika Gonzales',
      email: 'andhikagonzales@gmail.com',
  ...
  {
    id: 'usr-kirana-01',
    email: 'kirana@batikkirana.id',
    password: 'password123',
    user: {
      id: 'usr-kirana-01',
      name: 'Kirana Pramudita',
      email: 'kirana@batikkirana.id',
      phoneWhatsApp: '081234567890',
      avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&auto=format&fit=crop&q=80',
      role: 'merchant',
    ...
    merchant: {
      id: 'merch-usr-kirana-01',
      userId: 'usr-kirana-01',
      storeId: 'store-1',
      plan: 'premium',
      isVerified: true,
    },
  ...
  {
    id: 'usr-barista-01',
    email: 'barista@kedaikopi.id',
    password: 'password123',
    user: {
      id: 'usr-barista-01',
      name: 'Rian Barista Nusantara',
      email: 'barista@kedaikopi.id',
    ...
    merchant: {
      id: 'merch-usr-barista-01',
      userId: 'usr-barista-01',
      storeId: 'store-2',
      plan: 'starter',
      isVerified: true,
    },
  ...
  {
    id: 'usr-artisan-01',
    email: 'artisan@sepatugarut.id',
    password: 'password123',
    user: {
      id: 'usr-artisan-01',
      name: 'Hendra Artisan Garut',
      email: 'artisan@sepatugarut.id',
    ...
    merchant: {
      id: 'merch-usr-artisan-01',
      userId: 'usr-artisan-01',
      storeId: 'store-3',
      plan: 'premium',
      isVerified: true,
    },
