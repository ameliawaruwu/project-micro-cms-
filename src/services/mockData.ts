...
export const initialStores: Store[] = [
  {
    id: 'store-neoncore',
    merchantId: 'usr-neon-01',
    name: 'NEON//CORE Electronics',
    slug: 'neon-core-electronics',
    tagline: 'Pusat Hardware PC Gaming, GPU High-End & Elektronik Futuristik',
    description: 'Menyediakan komponen PC Komputer, VGA Card RTX Series, Gaming Peripherals, dan perangkat elektronik modern bergaransi resmi.',
    ...
    phoneWhatsApp: '081288889999',
    city: 'Jakarta Selatan, DKI Jakarta',
    province: 'DKI Jakarta',
    address: 'Mall Cyber Park Lt. 3 No. 88, Jakarta Selatan',
    category: 'Elektronik & Hardware PC',
    currency: 'IDR',
    balance: 15850000,
    onboarding: {
      storeNameSet: true,
  ...
  },
  {
    ...
    name: 'NEON//LAB Tech Accessories',
    slug: 'neon-lab-tech',
    tagline: 'Cyber Peripherals, Smart Gadgets & Custom Mechanical Keyboards',
    description: 'Menyediakan peripheral gaming, headset 7.1, keyboard mekanikal nirkabel, dan perangkat pintar futuristik.',
    logoUrl: 'https://images.unsplash.com/photo-1595225476474-87563907a212?w=200&auto=format&fit=crop&q=80',
    bannerUrl: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=1200&auto=format&fit=crop&q=80',
