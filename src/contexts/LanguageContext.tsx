...
export const translations: Translations = {
  ...
  // General Actions
  actions_save: { id: 'Simpan', en: 'Save' },
  actions_cancel: { id: 'Batal', en: 'Cancel' },
  actions_edit: { id: 'Ubah', en: 'Edit' },
  actions_delete: { id: 'Hapus', en: 'Delete' },
  actions_close: { id: 'Tutup', en: 'Close' },
  actions_search: { id: 'Cari', en: 'Search' },
  actions_filter: { id: 'Filter', en: 'Filter' },
  actions_back: { id: 'Kembali', en: 'Back' },
  actions_copied: { id: 'Tersalin!', en: 'Copied!' },
  actions_copy: { id: 'Salin', en: 'Copy' },
  actions_loading: { id: 'Memuat...', en: 'Loading...' },
  actions_view: { id: 'Lihat', en: 'View' },
  actions_open_store: { id: 'Buka Toko', en: 'Open Store' },

  // Bottom Navigation (Mobile)
  bottomnav_more: { id: 'Lainnya', en: 'More' },
  bottomnav_store_design: { id: 'Desain & Layout Toko', en: 'Store Design & Layout' },
  bottomnav_store_design_desc: { id: 'Atur banner, hero, & tampilan toko', en: 'Customize banners, hero & store appearance' },
  bottomnav_payment_methods: { id: 'Metode Pembayaran', en: 'Payment Methods' },
  bottomnav_payment_methods_desc: { id: 'Kelola QRIS, VA, dan rekening pencairan', en: 'Manage QRIS, VA, and payout accounts' },
  bottomnav_store_settings: { id: 'Pengaturan Toko', en: 'Store Settings' },
  bottomnav_store_settings_desc: { id: 'Nama toko, logo, kontak WA, & profil', en: 'Store name, logo, WhatsApp, & profile' },

  // Domain Management Page
  domain_page_title: { id: 'Domain Toko', en: 'Store Domain' },
  domain_page_subtitle: { id: 'Atur alamat web toko online Anda agar profesional dan mudah diingat pelanggan', en: 'Configure your online store web address for a professional and memorable customer experience' },
  domain_type_random: { id: 'Random Subdomain', en: 'Random Subdomain' },
  domain_type_random_desc: { id: 'Gratis selamanya dari sistem Kroomify', en: 'Free forever from Kroomify system' },
  domain_type_custom: { id: 'Custom Domain', en: 'Custom Domain' },
  domain_type_custom_desc: { id: 'Gunakan nama domain brand sendiri (.com, .id, dll)', en: 'Use your own custom brand domain (.com, .id, etc.)' },
  domain_available_ready: { id: 'Tersedia & Siap Pakai', en: 'Available & Ready to Use' },
  domain_btn_use: { id: 'Gunakan Domain', en: 'Use Domain' },
  domain_saving: { id: 'Menyimpan...', en: 'Saving...' },
  domain_copy_link: { id: 'Salin tautan', en: 'Copy link' },
  domain_open_store: { id: 'Buka toko', en: 'Open store' },
  domain_custom_title: { id: 'Cari & Beli Domain Kustom Baru', en: 'Search & Buy New Custom Domain' },
  domain_custom_subtitle: { id: 'Beli langsung dari sistem tanpa ribet atur DNS sendiri. Otomatis terhubung dan aktif SSL!', en: 'Buy directly from the system without complex DNS setup. Auto-connects with free SSL!' },
  domain_input_label: { id: 'Nama Domain yang Diinginkan', en: 'Desired Domain Name' },
  domain_input_placeholder: { id: 'nama-brand-kamu', en: 'your-brand-name' },
  domain_btn_check: { id: 'Cek Ketersediaan', en: 'Check Availability' },
  domain_btn_checking: { id: 'Memeriksa...', en: 'Checking...' },
  domain_dns_setup_title: { id: 'Panduan Pengaturan DNS Manual', en: 'Manual DNS Configuration Guide' },
  domain_dns_setup_desc: { id: 'Jika Anda sudah memiliki domain sendiri dari registrar luar, arahkan DNS records berikut ke server Kroomify:', en: 'If you already own a domain from an external registrar, point the following DNS records to Kroomify:' },
  domain_col_type: { id: 'Tipe Record', en: 'Record Type' },
  domain_col_host: { id: 'Nama Host', en: 'Host Name' },
  domain_col_target: { id: 'Nilai Target', en: 'Target Value' },
  domain_col_status: { id: 'Status Propagasi', en: 'Propagation Status' },
  domain_status_connected: { id: 'Terhubung & Aktif', en: 'Connected & Active' },
  domain_status_verifying: { id: 'Menunggu Propagasi DNS', en: 'Pending DNS Propagation' },
  domain_status_pending: { id: 'Menunggu Pembayaran', en: 'Awaiting Payment' },
  domain_premium_required: { id: 'Fitur Custom Domain Membutuhkan Paket Langganan', en: 'Custom Domain Feature Requires an Active Paid Plan' },
  domain_upgrade_hint: { id: 'Upgrade ke paket Starter atau Pro untuk mengaktifkan custom domain nama toko Anda.', en: 'Upgrade to Starter or Pro plan to activate your custom store domain.' },
  domain_upgrade_cta: { id: 'Lihat Paket Langganan', en: 'View Subscription Plans' },
  domain_toast_random_success: { id: 'Subdomain berhasil diatur dan aktif!', en: 'Subdomain successfully configured and active!' },
  domain_toast_copy_success: { id: 'Tautan domain berhasil disalin ke clipboard!', en: 'Domain link successfully copied to clipboard!' },

  // Order Details & Timeline Modals
  order_detail_title: { id: 'Rincian Pesanan', en: 'Order Details' },
  order_timeline_title: { id: 'Lacak Status Pesanan', en: 'Track Order Status' },
  order_btn_process_shipping: { id: 'Proses Kirim Resi', en: 'Process Shipping Tracking' },
  order_btn_print_receipt: { id: 'Cetak Struk / Resi', en: 'Print Receipt / Label' },
  order_btn_mark_completed: { id: 'Tandai Pesanan Selesai', en: 'Mark Order as Completed' },
  order_customer_info: { id: 'Informasi Pembeli', en: 'Customer Information' },
  order_shipping_address: { id: 'Alamat Pengiriman', en: 'Shipping Address' },
  order_items_title: { id: 'Daftar Produk Pesanan', en: 'Order Items List' },
  order_payment_summary: { id: 'Ringkasan Pembayaran', en: 'Payment Summary' },
  order_resi_copied: { id: 'Nomor resi pengiriman berhasil disalin!', en: 'Tracking number successfully copied!' },
  order_open_tracking: { id: 'Lacak Paket Online', en: 'Track Package Online' },
  order_subtotal: { id: 'Subtotal Produk', en: 'Items Subtotal' },
  order_shipping_fee: { id: 'Ongkos Kirim', en: 'Shipping Fee' },
  order_platform_fee: { id: 'Biaya Layanan', en: 'Platform Fee' },
  order_total_payment: { id: 'Total Pembayaran', en: 'Total Payment' },

  // Receipt Modal
  receipt_modal_title: { id: 'Cetak Dokumen Pesanan', en: 'Print Order Document' },
  receipt_format_shipping_label: { id: 'Label Pengiriman (Thermal A6)', en: 'Shipping Label (Thermal A6)' },
  receipt_format_invoice: { id: 'Invoice Resmi (A4)', en: 'Official Invoice (A4)' },
  receipt_format_thermal: { id: 'Struk Kasir (Thermal 80mm)', en: 'Cashier Receipt (Thermal 80mm)' },
  receipt_btn_print: { id: 'Cetak Sekarang', en: 'Print Document Now' },
  receipt_thermal_hint: { id: 'Pastikan ukuran kertas printer disesuaikan dengan format yang dipilih.', en: 'Ensure printer paper size matches the selected document format.' },

  // Confirm Delete Modal
  confirm_delete_title: { id: 'Konfirmasi Hapus Data', en: 'Confirm Deletion' },
  confirm_delete_message: { id: 'Apakah Anda yakin ingin menghapus data ini? Tindakan ini tidak dapat dibatalkan.', en: 'Are you sure you want to delete this item? This action cannot be undone.' },
  confirm_delete_btn: { id: 'Ya, Hapus', en: 'Yes, Delete' },
  confirm_delete_cancel: { id: 'Batal', en: 'Cancel' },
  confirm_deleting: { id: 'Menghapus...', en: 'Deleting...' },

  // Share Store Modal
  share_store_title: { id: 'Bagikan Toko Online Anda', en: 'Share Your Online Store' },
  share_store_desc: { id: 'Salin link toko atau scan QR Code untuk mulai promosi ke calon pelanggan', en: 'Copy store link or scan QR Code to promote your shop to customers' },
  share_store_copy_link: { id: 'Salin Link Toko', en: 'Copy Store Link' },
  share_store_copied: { id: 'Link toko berhasil disalin!', en: 'Store link successfully copied!' },
  share_store_qr_title: { id: 'QR Code Toko', en: 'Store QR Code' },
  share_store_download_qr: { id: 'Unduh QR Code', en: 'Download QR Code' },
  share_store_open_wa: { id: 'Bagikan via WhatsApp', en: 'Share via WhatsApp' },

  // Wallet Modal
  wallet_modal_title: { id: 'Dompet Toko & Penarikan Dana', en: 'Store Wallet & Payouts' },
  wallet_balance_ready: { id: 'Saldo Toko Aktif (Siap Ditarik)', en: 'Active Store Balance (Available)' },
  wallet_min_note: { id: 'Minimal penarikan dana Rp 50.000 ke rekening bank terdaftar.', en: 'Minimum payout is Rp 50,000 to your registered bank account.' },
  wallet_request_payout: { id: 'Ajukan Penarikan Saldo', en: 'Request Balance Withdrawal' },
  wallet_history_title: { id: 'Riwayat Transaksi Dompet', en: 'Wallet Transaction History' },
  wallet_empty_history: { id: 'Belum ada riwayat transaksi dompet.', en: 'No wallet transactions yet.' },
  wallet_nominal_label: { id: 'Nominal Penarikan', en: 'Withdrawal Amount' },
  wallet_nominal_placeholder: { id: 'Contoh: 100000', en: 'Example: 100000' },
  wallet_bank_destination: { id: 'Rekening Bank Tujuan', en: 'Destination Bank Account' },
  wallet_account_holder: { id: 'Atas Nama', en: 'Account Holder' },
  wallet_btn_submit: { id: 'Kirim Pengajuan', en: 'Submit Request' },
  wallet_btn_submitting: { id: 'Memproses...', en: 'Processing...' },
};
