  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        id: 'hero_banner',
        title: 'Hero Banner Utama',
        isVisible: true, order: 0, options: { bannerStyle: 'compact', sectionHeight: 'compact', textAlignment: 'left' },
      },
      {
        key: 'search-min',
        id: 'search_category',
      ...
      },
      {
        ...
        id: 'product_grid',
        title: 'Katalog Semua Produk',
        isVisible: true, order: 0, options: { gridColumns: 4, showStockBadge: true, showCategoryTabs: true },
      },
      {
        key: 'info-min',
        id: 'store_info',
        title: 'Informasi & Kontak',
        isVisible: true, order: 0, options: { showWhatsAppButton: true },
      },
      {
        key: 'footer-min',
        id: 'footer',
        title: 'Footer Toko',
        isVisible: true, order: 0, options: { showSocialLinks: true },
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        id: 'product_grid',
        title: 'Katalog Semua Produk',
        isVisible: true, order: 0, options: { gridColumns: 4, showStockBadge: true },
      },
      {
        key: 'testi-promo',
        id: 'testimonials',
        title: 'Ulasan & Testimoni',
        isVisible: true, order: 0, options: { testimonialsList: DEFAULT_TESTIMONIALS },
      },
      {
